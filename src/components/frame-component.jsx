      ...
      <div className="team-management-content">
        <div className="team-management-description">
          <div className="team-management-description-inner">
            <div className="manage-multiple-tiered-teams-group">
              <h2 className="manage-multiple-tiered1">
        ...
        <div className="footer-content">
          ...
          <div className="subscription-form">
            <div className="form-content">
              <div className="sivatel-tower-12th1">
              ...
              <div className="input-container">
                ...
                <button className="subscription-button">
                  ...
                  <div className="union-wrapper1">
                    <img className="union-icon4" alt="" src="/union-2.svg" />
                  </div>
                </button>
              </div>
            </div>
